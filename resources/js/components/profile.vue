    ...
    <div class="container">
        <div class="row ">
            <div class="col-md-12">
              ...
              <div class="widget-user-header text-white" style="background: url('images/home-banner.jpg') center center">
                <h3 class="widget-user-username">Sagar Humagain</h3>
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                      ...
                      <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                    <input type="" v-model="form.bio" class="form-control" id="inputExperience" placeholder="Experience" :class="{ 'is-invalid': form.errors.has('bio') }">
